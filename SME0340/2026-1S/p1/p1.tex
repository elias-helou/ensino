...
\begin{document}
    ...
    A prova deverá ser entregue através do sistema eDisciplinas até às 23:59 do dia 31/05/2026. A entrega deve ser através de um único arquivo no formato PDF. O arquivo PDF pode ser obtido através de digitalização de manuscritos ou geração direta (através de MarkDown, LaTeX, softwares de notas manuscritas, et.) desde que seja legível e que seja compatível com todos visualizadores.
